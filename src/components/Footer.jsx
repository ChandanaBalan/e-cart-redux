  ...
  return (
    <div className='py-10 md:px-20 px-10 bg-violet-900 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)] text-white'>
        <div>
            ...
            <p className='mt-5 text-justify'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facilis a quibusdam dicta, debitis quos laborum corrupti, doloribus fuga provident non quidem natus aperiam distinctio quasi exercitationem sunt atque doloremque earum.</p>
        </div>
        ...
        <div className='md:px-10 mt-10 md:mt-0'>
            ...
            <div className='flex  mt-6'>
                <input type="text" placeholder='Email Id' className='rounded p-3 w-full' />
                <button className='p-3 bg-orange-700 rounded ms-3'>Subscribe</button>
